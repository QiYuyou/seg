...
class Config(object):
    ...
    cityscapes_param = {'name': 'cityscapes',
                    ...
                    'eval_size': [800, 1280],
                    'eval_steps': 5,
                    'eval_list': r'F:\ICNet-tensorflow-master\data\train.txt',
                    'train_list': r'F:\ICNet-tensorflow-master\data\train.txt',
                    'data_dir': r'F:\ICNet-tensorflow-master\data'}
    ...
    INFER_SIZE = [800, 1280, 3]
    TRAINING_SIZE = [800, 1280]
